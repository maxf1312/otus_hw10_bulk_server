...
namespace otus_hw10{
    ...
    struct Options : public otus_hw9::Options
    {
        ...
        virtual Options& add_positional(otus_hw7::po::positional_options_description& pos_desc) override;
        virtual Options& add_caption_lines( std::string& caption) override;
    };
};